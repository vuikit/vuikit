<template>
  <div class="uk-block">
    ...
    <vk-tabs
      ...
      @change="events.change.emited = true">
    ...
    <vk-tabs>
      ...
      <vk-tab label="Slots">
        ...
        <vk-switcher :connect="$refs.slotsNav">
          <vk-switch>
            <vk-docs-slots :slots="slotsTabs"></vk-docs-slots>
          </vk-switch>
          <vk-switch>
            <vk-docs-slots :slots="slotsTab"></vk-docs-slots>
          </vk-switch>
        </vk-switcher> -->
      </vk-tab>
      <vk-tab label="Events">
...
<script>
import Tabs from '../../lib/Tabs/Default'
