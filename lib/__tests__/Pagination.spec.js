...
describe('Pagination', () => {
  ...
  it('renders correctly', () => {
    vm = createVue(`
      <vk-pagination :active="10" :total="200" :limit="10">
        <vk-pagination-first />
    ...
    vm = createVue(`
      <vk-pagination :active="10" :total="200" :limit="10" align="left">
        <vk-pagination-prev />
        <vk-pagination-next />
      </vk-pagination>
    `)
    ...
    vm = createVue(`
      <vk-pagination :active="10" :total="200" :limit="10" align="right">
        <vk-pagination-first />
        <vk-pagination-last />
      </vk-pagination>
    `)
    ...
    vm = createVue(`
      <vk-pagination :active="1" :total="0" :limit="10">
        <vk-pagination-pages />
      </vk-pagination>
    `)
    expect(renderSnapshot(vm)).toMatchSnapshot()
  ...
  it('triggers event change when a not active page is clicked', done => {
    vm = createVue(`
      <vk-pagination :active="20" :total="200" :limit="10">
        <vk-pagination-pages />
      </vk-pagination>
    `, true)
